...
const ListItems = () => {
    ...
    return (
        ...
        <div className="cart-container"  >
            <div className="cart-header" style={{ backgroundColor : "#345" ,margin:"0px" ,padding: " 20px"}}>
                <h2 className="cart-title" style={{ color : "whitesmoke"  }}>INVENTORY LIST</h2>
